...
export const DeepSeekModels: ModelDef[] = [
  ...
  },
  {
    ...
    provider: "deepseek",
    apiModelId: "deepseek-coder-v2.5",
    contextWindow: 64_000,
    maxOutputTokens: 8_192,
    costPerMInputTokens: 0.14,
    costPerMOutputTokens: 0.28,
...
export const FireworksModels: ModelDef[] = [
  ...
  },
  {
    ...
    name: "GLM-4.6",
    provider: "fireworks",
    apiModelId: "accounts/fireworks/models/glm-4-6",
    contextWindow: 128_000,
    maxOutputTokens: 8_192,
    costPerMInputTokens: 0.1,
    costPerMOutputTokens: 0.1,
    canReason: false,
    supportsAttachments: false,
    supportsStreaming: true,
    tier: "flagship",
...
export const HuggingFaceModels: ModelDef[] = [
  {
    id: "kimi-k2-instruct-hf",
    name: "Kimi K2 Instruct (HF)",
...
export const MoonshotModels: ModelDef[] = [
  ...
  {
    id: "kimi-k2-long-context",
    name: "Kimi K2 Long Context",
    provider: "moonshot",
    apiModelId: "kimi-k2-long-context",
    contextWindow: 1_000_000,
    maxOutputTokens: 32_000,
    costPerMInputTokens: 0.5,
